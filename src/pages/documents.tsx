...
export default function Documents() {
  ...
  return (
    <>
      <Head>
        <title>Documents | Client Connect</title>
        <meta name="description" content="Client documents and files" />
      </Head>
      ...
      >
        <div className="px-4 py-6 md:px-6 md:py-8">
          <h1 className="text-2xl font-bold text-gray-900 md:text-3xl">Documents</h1>
          <p className="mt-2 text-gray-600">Manage and share files with your client</p>
